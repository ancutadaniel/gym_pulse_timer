...
Simple HIIT interval timer with presets, a big ring, and voice cues.
...
## Keywords (draft)
hiit, interval timer, workout timer, tabata, fitness, training, rounds, sets, cardio, stopwatch, timer, workout
...
- **Review notes:** Note there is no login; mention audio cues and how to start a timer.
...
- Claiming features not in the build (e.g., Live Activities, background audio, or health metrics).
